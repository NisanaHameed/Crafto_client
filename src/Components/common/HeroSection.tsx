                ...
                <section className="max-w-7xl mx-auto px-3 pt-14 sm:px-16 lg:px-4 mb-12">
                    <article>
                        ...
                        <section className="mt-6 grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-8">
                            <article className="relative mx-auto w-full h-16 lg:h-20 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg hover:shadow-2xl  transition duration-300 ease-in-out">
