    ...
    return (
        <>
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-green-800">
                    <a href="https://flowbite.com/" className="flex items-center pt-4 pb-6">
                        <img src="/craftoLogo.png" className="w-48 rounded-lg h-14 me-3 bg-gray-300 object-cover" alt="Flowbite Logo" />
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a onClick={()=>navigate('/admin/professionals')} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <li>
                            <a onClick={()=>navigate('/admin/users')} className="flex cursor-pointer items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                    <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
                                </svg>
                        ...
                        <li>
                            <a onClick={handleLogout} className="flex items-center p-2 cursor-pointer text-gray-900 rounded-lg hover:bg-gray-100 group">
