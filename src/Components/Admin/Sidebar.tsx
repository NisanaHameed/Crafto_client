...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 pr-4 py-3 w-64 rounded h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-white shadow-md">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200 group">
                        ...
                        <li>
                            <a onClick={()=>navigate('/admin/professionals')} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200 group">
